...
#include "eeConfig.h"
#include <string.h>
#if (deviceType == BCU) || (deviceType == BD) || (deviceType==AutoPark)
extern		unsigned int	_EE_SIZE;
extern		unsigned int _EE_ADDR_INUSE;
extern    unsigned char _EE_FLASH_BANK;
extern    unsigned char _EE_PAGE_OR_SECTOR;
#endif
...
#if (deviceType != BCU) && (deviceType != BD) && (deviceType!=AutoPark)
#define   _EE_SIZE              64
#define   _EE_ADDR_INUSE        0x0801fc00
